...
// Si le panier est vide alors on push les données de customerSelection dans le local storage
...
// Définir constante si le produit est déjà présent dans le panier: trouver par id et couleur
...
// Si le produit (id+couleur identiques) est déjà prédent dans le panier alors on incrémente la quantité
                    ...
                    let newQuantity = parseInt(customerSelection.quantity) + parseInt(alreadyInCart.quantity);
